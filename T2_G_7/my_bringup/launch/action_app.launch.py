...
def generate_launch_description():
    ...
    # Percorso RViz config dal repo (T2_G_7/urdf_config.rviz) se esiste, altrimenti apre RViz senza config
    this_dir = os.path.dirname(__file__)
    rviz_config = os.path.abspath(os.path.join(this_dir, '..', '..', 'urdf_config.rviz'))
